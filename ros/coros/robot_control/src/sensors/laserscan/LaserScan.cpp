...
#include <iostream>
#include <iomanip>
#include "robot_control/LaserScan.h"

using namespace std;



double LaserScan::getAverageRange(sensor_msgs::LaserScan & laser_scan_msg, int start_index, int end_index){
  double avg = 0;
...
double LaserScan::getAverageRangeRight(sensor_msgs::LaserScan & laser_scan_msg, double degree){
  int start_index = 0;
...
double LaserScan::getAverageRangeLeft(sensor_msgs::LaserScan & laser_scan_msg, double degree){
...
double LaserScan::getAverageRangeStraight(sensor_msgs::LaserScan & laser_scan_msg, double degree){
...
double LaserScan::getMinimumRange(sensor_msgs::LaserScan & LaserScanMsg, int start_index, int end_index){
...
double LaserScan::getMinimumRangeRight(sensor_msgs::LaserScan & laser_scan_msg, double degree){
  int start_index = 0;
  int end_index = (int)(degree/radian2degree(laser_scan_msg.angle_increment));
  //cout<<"start_index RIGHT "<<start_index<<endl;
  //cout<<"end_index RIGHT"<<end_index<<endl;
...
double LaserScan::getMinimumRangeLeft(sensor_msgs::LaserScan & laser_scan_msg, double degree){
  int end_index = laser_scan_msg.ranges.size();
  int start_index = end_index- (int)(degree/radian2degree(laser_scan_msg.angle_increment));
  //cout<<"start_index LEFT "<<start_index<<endl;
  //cout<<"end_index LEFT"<<end_index<<endl;
...
double LaserScan::getMaximumRange(sensor_msgs::LaserScan & LaserScanMsg, int start_index, int end_index){
  //get initial value of max_index for the first valid range
  int max_index = 0;
  for(int i = start_index; i < end_index ; i++){
    if((LaserScanMsg.ranges[i]>= LaserScanMsg.range_min) && (LaserScanMsg.ranges[i]<= LaserScanMsg.range_max)){
...
double LaserScan::getMaximumRangeRight(sensor_msgs::LaserScan & laser_scan_msg, double degree){
  int start_index = 0;
  int end_index = (int)(degree/radian2degree(laser_scan_msg.angle_increment));
  //cout<<"start_index RIGHT "<<start_index<<endl;
  //cout<<"end_index RIGHT"<<end_index<<endl;
...
double LaserScan::getMaximumRangeLeft(sensor_msgs::LaserScan & laser_scan_msg, double degree){
  int end_index = laser_scan_msg.ranges.size();
  int start_index = end_index- (int)(degree/radian2degree(laser_scan_msg.angle_increment));
  //cout<<"start_index LEFT "<<start_index<<endl;
  //cout<<"end_index LEFT"<<end_index<<endl;
 ...
 * *********************************************************************/  
int LaserScan::getIndexOfMaximumRange(sensor_msgs::LaserScan & LaserScanMsg){
 ...
 * *********************************************************************/ 
int LaserScan::getIndexOfMinimumRange(sensor_msgs::LaserScan & LaserScanMsg){
...
double LaserScan::getMaximumRange(sensor_msgs::LaserScan & LaserScanMsg){
...
double LaserScan::getMinimumRange(sensor_msgs::LaserScan & LaserScanMsg){
  
  return LaserScanMsg.ranges[getIndexOfMinimumRange(LaserScanMsg)];
}

double  LaserScan::getFrontRange(sensor_msgs::LaserScan & LaserScanMsg){
 ...
 * ***************************************************************************/ 
double LaserScan::getRelativeAngleOfMaximumRange(sensor_msgs::LaserScan & LaserScanMsg){
 ...
 * ***************************************************************************/ 
double LaserScan::getRelativeAngleOfMinimumRange(sensor_msgs::LaserScan & LaserScanMsg){
  //we add minus to follow the rule of clockwise direction
 ...
 * Output: the angle corresponding to the miniumun range
 * ***************************************************************************/ 
bool LaserScan::isObstacleTooClose(sensor_msgs::LaserScan & LaserMsg, int start_index, int end_index, double DistanceThreshold){
  bool result=false;
...
void LaserScan::printLaserScanRanges(sensor_msgs::LaserScan & LaserScanMsg)
{
  ...
  cout << setw(20)<< "Maximum angle: " <<"["<<radian2degree(LaserScanMsg.angle_max)<<" rad, " <<radian2degree(LaserScanMsg.angle_max) <<" deg]" <<endl; //end angle of the scan [rad]
  cout << setw(20)<< "Minimum range: " <<LaserScanMsg.range_min <<" m"<<endl; //minimum range value [m]
