...
servos = [ 'arm_shoulder_pan_joint', 'arm_shoulder_lift_joint', 'arm_elbow_flex_joint', 'arm_wrist_flex_joint', 'gripper_joint']

forward = [1.5,-0.5, 0.7, 0.2, 1.5]
to_side = [1.5,1.0, 0.7, 0.5, 0.2]
tucked = [1.5,1.0, 0.7, 0.2, 1.5]
